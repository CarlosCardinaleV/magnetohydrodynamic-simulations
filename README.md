...
# Codigo original
Se proporciono un codigo en Matlab con el fin de pasarlo a C y paralelizarlo con MPI y con openMP para mejorar el rendimiento. El código en Matlab es el siguiente:
```Matlab
function mhd()
    global nNodos
    nNodos = 1000;
